                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    ...
                                    aria-label="Teacher: activate to sort column ascending">Type</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 132px;"
                                    aria-label="Lesson: activate to sort column ascending">Expired At</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                    rowspan="1" colspan="1" style="width: 94px;"
                                    aria-label="Enrolled: activate to sort column ascending">message</th>
                                <th scope="col" class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                            ...
                            @foreach ($newsAlerts as $newsAlert)
                                ...
                                <tr role="row" class="odd">
                                    <th scope="row" tabindex="0" class="sorting_1"> <a href="#"
                                            class="question_content"> {{ $newsAlert->id }}</a></th>
                                    <td>{{ $newsAlert->title }}</td>
                                    <td>{{ $newsAlert->type }}</td>

                                    <td>{{ $newsAlert->expire_at }}</td>
                                    <td>{{ $newsAlert->status }}</td>
