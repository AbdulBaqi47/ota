...
<!-- Mirrored from html.vecurosoft.com/travolo/demo/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 11:25:47 GMT -->
<head>
  <meta charset="utf-8">
  <meta http-equiv="x-ua-compatible" content="ie=edge">
  <title>
    Travolo - Travel Agency & Tour Booking HTML Template - Shop
  </title>
            ...
            <div class="vs-sort-bar">
              <div class="row justify-content-between align-items-center">
                <div class="col-md-auto col-sm-6 col-auto">
                  <p class="woocommerce-result-count">Showing 1–9 of 13 results</p>
                </div>
            ...
            <div class="row">
                ...
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product1.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                    </div>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Modern Cow Boy Hat</a></h3>
                    <span class="product-price">$ 100.00</span>
                    <a href="cart.html" class="vs-btn style4 w-100">Add to cart</a>
                  </div>
                </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product2.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Fujifilm Instax Mini 11</a></h3>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product3.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Compass for Hiking</a></h3>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product4.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Hydro Flask</a></h3>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product5.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Leather Travel Toiletry</a></h3>
                    <span class="product-price">$ 100.00</span>
                    <a href="cart.html" class="vs-btn style4 w-100">Add to cart</a>
                  </div>
                </div>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product6.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Cotton Bath Towels</a></h3>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product7.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Hiking Backpack</a></h3>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product8.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Alpine Ski</a></h3>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="vs-product">
                  <div class="product-img">
                    <a href="shop-details.html">
                      <img src="assets/img/products/product9.png" alt="Products Img">
                    </a>
                    <div class="action-buttons">
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-eye"></i></a>
                      <a href="shop-details.html" class="icon-btn"><i class="fas fa-heart"></i></a>
                  ...
                  <div class="product-body">
                    ...
                    <h3 class="product-title"><a href="shop-details.html">Cat Eye Sunglasses</a></h3>
              ...
              <div class="widget">
                ...
                <div class="latest-post-wrap">
                  <div class="latest-post">
                    <div class="media-img">
                      <a href="shop-details.html">
                        <img src="assets/img/products/product1.png" alt="Blog Image">
                      </a>
                    </div>
                    <div class="media-body">
                      <h4 class="post-title">
                        <a class="text-inherit" href="blog-details.html">Cow Boy Hat</a>
                      </h4>
                      <span class="product-price">$ 100.00</span>
                    </div>
                  </div>
                  <div class="latest-post">
                    <div class="media-img">
                      <a href="shop-details.html">
                        <img src="assets/img/products/product2.png" alt="Blog Image">
                      </a>
                    </div>
                    <div class="media-body">
                      <h4 class="post-title">
                        <a class="text-inherit" href="blog-details.html">Fujifilm Instax</a>
                      </h4>
                      <span class="product-price">$ 100.00</span>
                    </div>
                  </div>
                  <div class="latest-post">
                    <div class="media-img">
                      <a href="shop-details.html">
                        <img src="assets/img/products/product3.png" alt="Blog Image">
                      </a>
                    </div>
                    <div class="media-body">
                      <h4 class="post-title">
                        <a class="text-inherit" href="blog-details.html">Hiking Compass</a>
                      </h4>
                      <span class="product-price">$ 100.00</span>
                    </div>
                  </div>
...
<!-- Mirrored from html.vecurosoft.com/travolo/demo/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 11:25:49 GMT -->
</html>