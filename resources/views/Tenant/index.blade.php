...
<head>
  ...
  <link rel="icon" type="image/png" href=" {{ asset('tenants/' . tenant('id') . '/assets/img/favicons/favicon.png')}}">
  ...
  <!--==============================
    ...
    ============================== -->
  <!-- Bootstrap -->
  <!-- <link rel="stylesheet" href="{{ asset('tenants/' . tenant('id') . '/assets/css/app.min.css')}}"> -->
  <link rel="stylesheet" href="{{ asset('tenants/' . tenant('id') . '/assets/css/bootstrap.min.css')}}">
  <!-- Fontawesome Icon -->
  <link rel="stylesheet" href="{{ asset('tenants/' . tenant('id') . '/assets/css/fontawesome.min.css')}}">
  <!-- Magnific Popup -->
  <link rel="stylesheet" href="{{ asset('tenants/' . tenant('id') . '/assets/css/magnific-popup.min.css')}}">
  <!-- Slick Slider -->
  <link rel="stylesheet" href="{{ asset('tenants/' . tenant('id') . '/assets/css/slick.min.css')}}">
  <!-- Theme Custom CSS -->
  <link rel="stylesheet" href="{{ asset('tenants/' . tenant('id') . '/assets/css/style.css')}}">
</head>
...
<body>
      ...
      <div class="vs-mobile-menu">
        <ul>
          <li class="menu-item-has-children">
            ...
            <ul class="sub-menu">
              <li><a href="index.html">Home wwww</a></li>
      ...
      <div class="sticky-active">
        <div class="container position-relative z-index-common">
          <div class="row align-items-center justify-content-between">
            <div class="col-auto">
              <div class="vs-logo">
                <a href="index.html"><h1>{{ucfirst(tenant('id'))}}</h1></a>
              </div>
            </div>
  ...
  <!--==============================
    Hero Area Start
  ==============================-->
  <section class="hero-layout" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/banner/banner-bg-1.png')}}">
    <div class="hero-mask">
        ...
        <div class="hero-slide">
          <div class="container">
            <div class="row align-items-center justify-content-between">
              ...
              <div class="col-lg-6">
                <div class="hero-img">
                  <img class="img1" src="{{ asset('tenants/' . tenant('id') . '/assets/img/banner/banner-img-1-1.jpg')}}" alt="hero">
                  <img class="img2" src="{{ asset('tenants/' . tenant('id') . '/assets/img/banner/banner-img-1-2.jpg')}}" alt="hero">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="hero-slide">
          <div class="container">
            <div class="row align-items-center justify-content-between">
              ...
              <div class="col-lg-6">
                <div class="hero-img">
                  <img class="img1" src="{{ asset('tenants/' . tenant('id') . '/assets/img/banner/banner-img-2-1.jpg')}}" alt="hero">
                  <img class="img2" src="{{ asset('tenants/' . tenant('id') . '/assets/img/banner/banner-img-2-2.jpg')}}" alt="hero">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="hero-slide">
          <div class="container">
            <div class="row align-items-center justify-content-between">
              ...
              <div class="col-lg-6">
                <div class="hero-img">
                  <img class="img1" src="{{ asset('tenants/' . tenant('id') . '/assets/img/banner/banner-img-3-1.jpg')}}" alt="hero">
                  <img class="img2" src="{{ asset('tenants/' . tenant('id') . '/assets/img/banner/banner-img-3-2.jpg')}}" alt="hero">
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="space-top space-extra-bottom blog-wrapper1 shape-mockup-wrap">
    <div class="shape-mockup d-none d-xl-block spin z-index-negative" data-top="-5%" data-left="-5%">
      <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/circle1.png')}}" alt="circle">
    </div>
    <div class="shape-mockup d-none d-xl-block jump z-index-negative" data-bottom="5%" data-right="5%">
      <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/Dot.png')}}" alt="Dots">
    </div>
    <div class="container">
      ...
      <div class="blog-style4">
        <div class="blog-image">
          <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/blog-a-1-1.jpg')}}" alt="blog image">
          <div class="category-tag"><a href="#"><i class="fas fa-tag"></i> Tips</a></div>
        </div>
        <div class="blog-content" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/blog-bg.png')}}">
          <a class="blog-date" href="blog-details.html"><i class="far fa-calendar-alt "></i> July 21, 2023</a>
          <h3 class="blog-title"><a href="blog-details.html">A Time to Travel And Find Breathtaking Landscapes For
              Relax</a></h3>
      ...
      <div class="blog-style4">
        <div class="blog-image">
          <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/blog-a-1-2.jpg')}}" alt="blog image">
          <div class="category-tag"><a href="#"><i class="fas fa-tag"></i> Tips</a></div>
        </div>
        <div class="blog-content" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/blog-bg.png')}}">
          <a class="blog-date" href="blog-details.html"><i class="far fa-calendar-alt "></i> July 21, 2023</a>
  ...
  <!--==============================
    ...
    ==============================-->
  <section class="space bg-light shape-mockup-wrap" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/Bg.png')}}">
    ...
    <div class="shape-mockup d-none d-xl-block ripple-animation z-index-negative" data-top="10%" data-left="10%">
      <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/Plane.png')}}" alt="plane">
    </div>
    <div class="container ">
      <div class="row justify-content-center text-center">
      ...
      <div class="row vs-carousel" data-slide-show="4" data-arrows="false" data-lg-slide-show="3" data-md-slide-show="2"
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{ asset('tenants/' . tenant('id') . '/assets/img/tours/tour-1-1.jpg')}}"
                  alt="Package Image"></a>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{ asset('tenants/' . tenant('id') . '/assets/img/tours/tour-1-2.jpg')}}"
                  alt="Package Image"></a>
            </div>
            <div class="package-content">
              <div class="package-review">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{ asset('tenants/' . tenant('id') . '/assets/img/tours/tour-1-3.jpg')}}"
                  alt="Package Image"></a>
            </div>
            <div class="package-content">
              <div class="package-review">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{ asset('tenants/' . tenant('id') . '/assets/img/tours/tour-1-4.jpg')}}"
                  alt="Package Image"></a>
            </div>
            <div class="package-content">
              <div class="package-review">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{ asset('tenants/' . tenant('id') . '/assets/img/tours/tour-1-5.jpg')}}"
                  alt="Package Image"></a>
            </div>
            <div class="package-content">
              <div class="package-review">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{ asset('tenants/' . tenant('id') . '/assets/img/tours/tour-1-6.jpg')}}"
                  alt="Package Image"></a>
            </div>
            <div class="package-content">
              <div class="package-review">
        ...
        <div class="col-xl-6">
          ...
          <div class="row">
            <div class="col-xl-6 col-sm-6">
              <img class="gallery-image" src="{{ asset('tenants/' . tenant('id') . '/assets/img/gallery/gallery-1-1.jpg')}}" alt="images">
            </div>
            <div class="col-xl-6 col-sm-6">
              <img class="gallery-image" src="{{ asset('tenants/' . tenant('id') . '/assets/img/gallery/gallery-1-2.jpg')}}" alt="images">
            </div>
          </div>
        </div>
        <div class="col-xl-6">
          <div class="gallery-video">
            <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/gallery/gallery-1-3.jpg')}}" alt="gallery-image">
      ...
      <div class="row">
        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
          <div class="features-style1">
            <div class="features-bg" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/features.png')}}"></div>
            <div class="features-image">
              <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/features/features-1-1.png')}}" alt="image">
            </div>
        ...
        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
          <div class="features-style1">
            <div class="features-bg" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/features.png')}}"></div>
            <div class="features-image">
              <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/features/features-1-2.png')}}" alt="image">
            </div>
            <div class="features-content">
        ...
        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
          <div class="features-style1">
            <div class="features-bg" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/features.png')}}"></div>
            <div class="features-image">
              <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/features/features-1-3.png')}}" alt="image">
            </div>
            <div class="features-content">
        ...
        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
          <div class="features-style1">
            <div class="features-bg" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/features.png')}}"></div>
            <div class="features-image">
              <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/features/features-1-4.png')}}" alt="image">
            </div>
            <div class="features-content">
  ...
  <!--==============================
    ...
    ==============================-->
  <section class="space position-relative" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/bg/offer-bg.jpg')}}">
    <div class="container">
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6">
          <div class="img-box1">
            <img class="img-1-1" src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/offer-1-1.png')}}" alt="Offer image">
            <div class="img-1-2 d-none d-xxl-block">
              <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/bag.png')}}" alt="image">
            </div>
          </div>
        </div>
      </div>
  ...
  ==============================-->
  <section class="space space-extra-bottom bg-light shape-mockup-wrap" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/Bg.png')}}">
    ...
    <div class="shape-mockup d-none d-xl-block  z-index-negative" data-bottom="13%" data-left="0%">
      <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/walk.png')}}" alt="circle">
    </div>
    <div class="container">
      <div class="row justify-content-between align-items-center">
      ...
      <div class="row destinationSlide vs-carousel" data-slide-show="3" data-arrows="false" data-lg-slide-show="2"
        ...
        <div class="col-xl-4">
          <div class="destination-style1">
            <a href="destination-details.html"> <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/destinations/destinations-1-1.jpg')}}"
        ...
        <div class="col-xl-4">
          <div class="destination-style1">
            <a href="destination-details.html"> <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/destinations/destinations-1-2.jpg')}}"
                alt="destination image"></a>
        ...
        <div class="col-xl-4">
          <div class="destination-style1">
            <a href="destination-details.html"> <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/destinations/destinations-1-3.jpg')}}"
                alt="destination image"></a>
        ...
        <div class="col-xl-4">
          <div class="destination-style1">
            <a href="destination-details.html">
              <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/destinations/destinations-1-8.jpg')}}" alt="destination image" /></a>
  ...
  <!--==============================
    ...
    ==============================-->
  <section class="space testimonial-style1" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/bg/testimonial-bg.jpg')}}">
    <div class="container">
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-xxl-6 col-xl-7">
          <div class="testi-style1">
            <div class="testi-avaters vs-slider-tab" data-asnavfor="#testId">
              <button class="tab-btn active"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-1.jpg')}}" alt="avater" /></button>
              <button class="tab-btn"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-2.jpg')}}" alt="avater" /></button>
              <button class="tab-btn"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-3.jpg')}}" alt="avater" /></button>
              <button class="tab-btn"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-4.jpg')}}" alt="avater" /></button>
            </div>
            ...
            <div class="vs-carousel" id="testId" data-slide-show="1" data-fade="true">
              <div class="position-relative z-index-common">
                <div class="testi-quote">
                  <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/shape/quote1.png')}}" alt="quote">
                </div>
                ...
                <p class="testi-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation nim
                  vengiam, quis ullamco.</p>
                <div class="testi-avater">
                  <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-1.jpg')}}" alt="customer image">
                </div>
              ...
              <div class="position-relative z-index-common">
                ...
                <p class="testi-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                  ...
                  vengiam, quis ullamco.</p>
                <div class="testi-avater">
                  <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-2.jpg')}}" alt="customer image">
                </div>
              ...
              <div class="position-relative z-index-common">
                ...
                <p class="testi-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                  ...
                  vengiam, quis ullamco.</p>
                <div class="testi-avater">
                  <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-3.jpg')}}" alt="customer image">
                </div>
                <h3 class="testi-name">Rodja Heartmann</h3>
                <span class="testi-degi">CEO, Vecuro</span>
              </div>
              <div class="position-relative z-index-common">
                ...
                <p class="testi-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                  ...
                  vengiam, quis ullamco.</p>
                <div class="testi-avater">
                  <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/testimonial/avater-1-4.jpg')}}" alt="customer image">
                </div>
                <h3 class="testi-name">Rodja Heartmann</h3>
                <span class="testi-degi">CEO, Vecuro</span>
              </div>
  ...
  <section class="space space-extra-bottom blog-wrapper">
    <div class="container">
      ...
      <div class="row vs-carousel" data-slide-show="3" data-arrows="false" data-lg-slide-show="2" data-md-slide-show="2"
        data-sm-slide-show="1" adaptiveHeight="true">
        <div class="col-xl-4">
          <div class="vs-blog blog-style3">
            <div class="blog-img">
              <a href="blog-details.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/blog-h-1-1.jpg')}}" alt="blog image"></a>
            </div>
        ...
        <div class="col-xl-4">
          <div class="vs-blog blog-style3">
            <div class="blog-img">
              <a href="blog-details.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/blog-h-1-2.jpg')}}" alt="blog image"></a>
            </div>
            <div class="blog-content">
        ...
        <div class="col-xl-4">
          <div class="vs-blog blog-style3">
            <div class="blog-img">
              <a href="blog-details.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/blog-h-1-3.jpg')}}" alt="blog image"></a>
            </div>
            <div class="blog-content">
        ...
        <div class="col-xl-4">
          <div class="vs-blog blog-style3">
            <div class="blog-img">
              <a href="blog-details.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/blog-h-1-4.jpg')}}" alt="blog image"></a>
            </div>
            <div class="blog-content">
  ...
  <!--==============================
      Footer Area
  ==============================-->
  <footer class="footer-wrapper footer-layout1" data-bg-src="{{ asset('tenants/' . tenant('id') . '/assets/img/bg/footer-bg.jpg')}}">
          ...
          <div class="row g-5 align-items-center justify-content-between">
            ...
            <div class="col-md-5 col-sm-6">
              <div class="cta-image d-lg-block d-none">
                <img src="{{ asset('tenants/' . tenant('id') . '/assets/img/newsletter.png')}}" alt="CTA Image">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="widget footer-widget">
              <div class="vs-widget-about">
                <div class="footer-logo">
                  <a href="index.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/white-logo.svg')}}" alt="Travolo" class="logo" /></a>
                </div>
          ...
          <div class="col-md-6 col-xl-3">
            <div class="widget footer-widget">
              ...
              <div class="sidebar-gallery">
                <a href="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta1.jpg')}}" class="popup-image"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta1.jpg')}}"
                    alt="Gallery Image" class="w-100" />
                </a>
                <a href="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta2.jpg')}}" class="popup-image"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta2.jpg')}}"
                    alt="Gallery Image" class="w-100" />
                </a>
                <a href="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta3.jpg')}}" class="popup-image"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta3.jpg')}}"
                    alt="Gallery Image" class="w-100" />
                </a>
                <a href="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta4.jpg')}}" class="popup-image"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta4.jpg')}}"
                    alt="Gallery Image" class="w-100" />
                </a>
                <a href="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta5.jpg')}}" class="popup-image"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta5.jpg')}}"
                    alt="Gallery Image" class="w-100" />
                </a>
                <a href="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta6.jpg')}}" class="popup-image"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/footer/insta6.jpg')}}"
                    alt="Gallery Image" class="w-100" />
                </a>
              </div>
            </div>
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-lg-auto">
            <p class="copyright-text">Copyright <i class="fal fa-copyright"></i>
              <script>document.write(new Date().getFullYear())</script> <a href="index.html">Travolo</a>.
  ...
  <div class="sidemenu-wrapper offcanvas-wrapper d-none d-lg-block">
    <div class="sidemenu-content">
      ...
      <div class="widget">
        <div class="vs-widget-about">
          <div class="footer-logo">
            <a href="index.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/logo.svg')}}" alt="Travolo"></a>
          </div>
          <p class="footer-text">
      ...
      <div class="widget">
        ...
        <div class="recent-post-wrap">
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/recent-post1.jpg')}}" alt="Blog Image"></a>
            </div>
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/recent-post2.jpg')}}" alt="Blog Image"></a>
            </div>
            <div class="media-body">
              <div class="recent-post-meta">
                <i class="fal fa-calendar-alt"></i>
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="{{ asset('tenants/' . tenant('id') . '/assets/img/blog/recent-post3.jpg')}}" alt="Blog Image"></a>
            </div>
            <div class="media-body">
              <div class="recent-post-meta">
                <i class="fal fa-calendar-alt"></i>
          ...
          <ul class="cart_list">
            <li class="mini_cart_item">
              <a href="shop.html" class="remove"><i class="fal fa-trash-alt"></i></a> <a href="shop.html"><img
                  src="{{ asset('tenants/' . tenant('id') . '/assets/img/products/p-1-1.png')}}" alt="Cart Image" />Modern Cow Boy Hat</a>
              <span class="quantity">
            ...
            <li class="mini_cart_item">
              <a href="shop.html" class="remove"><i class="fal fa-trash-alt"></i></a> <a href="shop.html"><img
                  src="{{ asset('tenants/' . tenant('id') . '/assets/img/products/p-1-2.png')}}" alt="Cart Image" />Cat Eye Sunglasses</a>
              <span class="quantity">
  ...
  <!--==============================
    ...
    ============================== -->
  <!-- Jquery -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/vendor/jquery-3.6.0.min.js')}}"></script>
  <!-- Slick Slider -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/slick.min.js')}}"></script>
  <!-- Bootstrap -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/bootstrap.min.js')}}"></script>
  <!-- Magnific Popup -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/jquery.magnific-popup.min.js')}}"></script>
  <!-- jquery Ui -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/jquery-ui.min.js')}}"></script>
  <!-- Circle Progress -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/circle-progress.min.js')}}"></script>
  <!-- isotope -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/imagesLoaded.js')}}"></script>
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/isotope.js')}}"></script>
  <!-- Wow.js')}} -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/wow.min.js')}}"></script>
  <!-- Main Js File -->
  <script src="{{ asset('tenants/' . tenant('id') . '/assets/js/main.js')}}"></script>
</body>


<!-- Mirrored from html.vecurosoft.com/travolo/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 11:24:55 GMT -->
</html>
