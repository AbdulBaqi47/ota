...
<!-- Mirrored from html.vecurosoft.com/travolo/demo/destination-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 11:25:40 GMT -->
<head>
  <meta charset="utf-8">
  <meta http-equiv="x-ua-compatible" content="ie=edge">
  <title>
    Travolo - Travel Agency & Tour Booking HTML Template - Destination Details
  </title>
...
<body>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="destination-details">
            <h2 class="ds-title">Spain</h2>
            <div class="ds-img1">
              <img src="assets/img/destinations/destination-s-1-1.jpg" alt="image">
            </div>
            <p class="ds-text">Nulla porttitor accumsan tincidunt. Curabitur aliquet quam id dui posuere blandit.
              Vestibulum ac diam sit amet for a quam vehicula elementum sed sit amet dui. Donec sollicitudin molestie
              malesuada. Donec sollicitudin molestie malesuada. Proin eget tortor risus. Quisque velit nisi, pretium ut
              lacinia in, elementum id enim. Pellentesque in ipsum id orci porta dapibus. Vestibulum ac diam sit amet
              quam vehicula elementum sed sit amet dui. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque
              velit nisi, pretium ut lacinia in, elementum id enim. Pellentesque in ipsum id orci porta dapibus.
              Vestibulum ac diam sit amet quam vehicula elementum segd sit amet dui. Lorem ipsum dolor sit amet,
              consectetur adipiscing ipsum dolor sit amet, consectetur elit.</p>
            <p class="ds-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque velit nisi, pretium ut
              lacinia in, elementum id enim. Pellentesque in ipsum id orci porta dapibus. Vestibulum ac diam sit amet
              quam vehicula elementum sed sit amet dui. Lorem ipsum dolor sit amet, consectetur adipiscing ipsum dolor
            ...
            <div class="destinations-info">
              <h2>Know About Some Important Info</h2>
              <p>Curabitur aliquet quam id dui posuere blandit. Vivamls magna justo, lacinia eget consectetur sed,
                convgallis at tellus. The Vesgibulum ac agna justo, lacinia eget cons diam sit.</p>
              <ul class="destination-list">
                <li><span>Country</span> <span>Spain</span></li>
                <li><span>Visa Requirements</span> <span>Yes, Needed. {Not Needed for EU Citizens.}</span></li>
                <li><span>Languages spoken</span> <span>Spanish & English</span></li>
                <li><span>Currency Name</span> <span>Euro</span></li>
                <li><span>Area (km²)</span> <span>Spain area is 505,990 km2 (195,360 sq mi)</span></li>
              </ul>
            </div>
              ...
              <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12 col-auto">
                  <div class="gallery-img5">
                    <img src="assets/img/destinations/destination-s-1-4.jpg" alt="images">
                    <div class="gallery-content">
                      <a href="assets/img/destinations/destination-s-1-4.jpg" class="popup-image"><i
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-auto">
                  <div class="gallery-img5">
                    <img src="assets/img/destinations/destination-s-1-5.jpg" alt="images">
                    <div class="gallery-content">
                      <a href="assets/img/destinations/destination-s-1-5.jpg" class="popup-image"><i
                          class="fas fa-plus"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-auto">
                  <div class="gallery-img5">
                    <img src="assets/img/destinations/destination-s-1-6.jpg" alt="images">
                    <div class="gallery-content">
                      <a href="assets/img/destinations/destination-s-1-6.jpg" class="popup-image"><i
                          class="fas fa-plus"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-auto">
                  <div class="gallery-img5">
                    <img src="assets/img/destinations/destination-s-1-7.jpg" alt="images">
                    <div class="gallery-content">
                      <a href="assets/img/destinations/destination-s-1-7.jpg" class="popup-image"><i
                          class="fas fa-plus"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-auto">
                  <div class="gallery-img5">
                    <img src="assets/img/destinations/destination-s-1-8.jpg" alt="images">
                    <div class="gallery-content">
                      <a href="assets/img/destinations/destination-s-1-8.jpg" class="popup-image"><i
                          class="fas fa-plus"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-auto">
                  <div class="gallery-img5">
                    <img src="assets/img/destinations/destination-s-1-9.jpg" alt="images">
                    <div class="gallery-content">
                      <a href="assets/img/destinations/destination-s-1-9.jpg" class="popup-image"><i
                          class="fas fa-plus"></i></a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-8 col-md-12 col-sm-12 col-auto">
                  <div class="gallery-img5">
                    <img src="assets/img/destinations/destination-s-1-10.jpg" alt="images">
                    <div class="gallery-content">
                      <a href="assets/img/destinations/destination-s-1-10.jpg" class="popup-image"><i
                          class="fas fa-plus"></i></a>
                    </div>
                  </div>
                </div>
          ...
          <div class="sidebar-area">
            ...
            <div class="widget">
              ...
              <div class="recent-post-wrap">
                <div class="recent-post">
                  ...
                  <div class="media-body">
                    <h4 class="post-title">
                      <a class="text-inherit" href="blog-details.html">Lorem ipsum dolor
                        sit agmet.</a>
                    </h4>
                    <div class="recent-post-meta">
            ...
            <div class="widget widget_tag_cloud">
              ...
              <div class="tagcloud">
                ...
                <a href="blog.html">Camp</a>
                <a href="blog.html">summer</a>
                <a href="blog.html">Winter</a>
                <a href="blog.html">City</a>
                <a href="blog.html">Adventure</a>
                <a href="blog.html">Nature</a>
                <a href="blog.html">Fun</a>
  ...
  <!--==============================
	  Footer Area
	==============================-->
  <footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer-bg.jpg">
...
<!-- Mirrored from html.vecurosoft.com/travolo/demo/destination-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 11:25:43 GMT -->
</html>