...
<!-- Mirrored from html.vecurosoft.com/travolo/demo/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 11:25:53 GMT -->
<head>
  <meta charset="utf-8">
          ...
          <table class="cart_table">
            ...
            <tbody>
              <tr class="cart_item">
                ...
                <td data-title="Price">
                  <span class="amount"><bdi><span>$</span>100</bdi></span>
                </td>
              ...
              <tr class="cart_item">
                ...
                <td data-title="Price">
                  <span class="amount"><bdi><span>$</span>10</bdi></span>
                </td>
                <td data-title="Quantity">
                  <div class="quantity">
                    <button class="quantity-minus qut-btn">
          ...
          <table class="cart_totals">
            <tbody>
              <tr>
                ...
                <td data-title="Cart Subtotal">
                  <span class="amount"><bdi><span>$</span>110</bdi></span>
                </td>
              </tr>
              <tr class="shipping">
            ...
            <tfoot>
              <tr class="order-total">
                <td>Order Total</td>
                <td data-title="Total">
                  <strong><span class="amount"><bdi><span>$</span>110</bdi></span></strong>
                </td>
              </tr>
            </tfoot>
          </table>
          <a href="checkout.html" class="vs-btn w-100 style4">Proceed to checkout</a>
        </div>
      </div>
    </div>
  </div>
