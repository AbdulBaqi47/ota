<nav class="sidebar">
    <div class="logo d-flex justify-content-between">
        <a href="index-2.html"><img src = "{{ asset('Admin/img/logo.svg ') }}" alt></a>
        <div class="sidebar_close_icon d-lg-none">
            <i class="ti-close"></i>
        </div>
    </div>
    <ul id="sidebar_menu" >
        <li class="mm-active mr-5" >
            <a class="" href="{{route('centralDasboard')}}">
        ...
        <li class>
            ...
            <ul>
                <li><a  href="{{route('showTenant')}}">Tenants list</a></li>
                <li><a href="{{route('createTenant')}}">Create New</a></li>
            </ul>
        </li>
        {{-- <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
