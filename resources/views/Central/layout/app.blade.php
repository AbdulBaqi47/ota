...
<head>
    ...
    <title>Buraq Alliance</title>
    <link rel="icon" href="{{ asset('Admin/img/logo.svg ') }}" type="image/png">
...
<body class="crm_body_bg">
                            ...
                            <div class="header_notification_warp d-flex align-items-center">
                                    ...
                                    <div class="Menu_NOtification_Wrap">
                                        ...
                                        <div class="Notification_body">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img
                                                            src = "{{ asset('Admin/img/staf/3.png ') }}" alt></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img
                                                            src = "{{ asset('Admin/img/staf/2.png ') }}" alt></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                                        <h5>Cool Directory </h5>
                                            ...
                                            <div class="single_notify d-flex align-items-center">
                                                <div class="notify_thumb">
                                                    <a href="#"><img
                                                            src = "{{ asset('Admin/img/staf/4.png ') }}" alt></a>
                                                </div>
                                                <div class="notify_content">
                                                    <a href="#">
                                                        <h5>Awesome packages</h5>
                                ...
                                <li>
                                    <a class="CHATBOX_open" href="#"> <img
                                            src = "{{ asset('Admin/img/icon/msg.svg ') }}" alt> <span>01</span> </a>
                                </li>
                            </div>
                            <div class="profile_info">
                                ...
                                <div class="profile_info_iner">
                                    ...
                                    <div class="profile_info_details">
                                        <a href="#">My Profile </a>
                                        <a href="#">Settings</a><form method="POST" action="{{ route('logout') }}">
                            @csrf
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer_iner text-center">
                            <p>2024 © Influence - Designed by BuraqSol </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="Chat_Listed_member">
                <ul>
                    ...
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src = "{{ asset('Admin/img/staf/2.png ') }}" alt>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src = "{{ asset('Admin/img/staf/3.png ') }}" alt>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src = "{{ asset('Admin/img/staf/4.png ') }}" alt>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src = "{{ asset('Admin/img/staf/5.png ') }}" alt>
                            </div>
                        </a>
                    </li>
                    <li>
    ...
    <script src="{{ asset('Admin/vendors/apex_chart/apex_realestate.js ') }}"></script>
    ...
    <script src="{{ asset('Admin/vendors/apex_chart/apex_chart_list.js ') }}"></script>
</body>

<!-- Mirrored from demo.dashboardpack.com/directory-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Aug 2024 05:39:37 GMT -->
